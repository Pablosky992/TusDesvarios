...
const storyPath = path.join(__dirname, '..', 'data', 'stories', 'la-ultima-guardia-faro.json');
...
const nodeIds = [
  ...
  "nodo_4_archivo",
  "nodo_5_cupula",
  "nodo_6_templo_sumergido",
  "nodo_7_quemar_glifos",
  "nodo_8_descifrar_diario",
  "nodo_9_radiograma_militar",
  "nodo_10_morse_ahogados",
  "nodo_11_expediente_secreto",
  "nodo_12_activar_diapason",
  "nodo_13_batalla_fuerza_luz",
  "nodo_14_pasarela_exterior",
  "nodo_15_invertir_foco",
  "nodo_16_destruir_altar",
  "nodo_17_barricada_intermedia",
  "nodo_18_trampa_marina",
  "nodo_19_inmolacion_preparar",
  "nodo_final_alba",
  "nodo_final_venganza",
  "nodo_final_hierofante",
  "nodo_final_inmolacion",
  "nodo_final_bucle",
  "nodo_final_abismo"
];
...
// Convert local image paths to Base64 for 100% self-contained PDF/Word document
...
const coverBase64 = getBase64Image('images/stories/faro-san-telmo/portada.jpg');
...
<head>
  <meta charset="UTF-8">
  <title>${story.titulo} — LibroJuego Interactivo</title>
  <style>
...
<body>
  ...
  <div class="cover-page">
    ...
    <div class="cover-meta">
      ...
      <p style="margin-top: 0.5rem; font-size: 9pt;">Librojuego de Ficción Interactiva con 25 Secciones Numeradas y 6 Desenlaces</p>
    </div>
  </div>
  ...
  <div class="instructions-page">
    ...
    <div class="instructions-body">
      <p>Tienes en tus manos un <strong>Librojuego interactivo</strong>. A diferencia de una novela tradicional, aquí no debes leer las páginas de forma consecutiva.</p>
      <ul>
        <li>Comenzarás siempre en la sección <strong>1</strong>.</li>
        <li>Al final de cada sección, se te presentarán varias opciones que representan las decisiones de tu personaje, Mateo.</li>
        <li>Cada opción te indicará a qué número de sección debes acudir (por ejemplo: <em>«Pasa al 5»</em>).</li>
        ...
        <li>Existen <strong>6 finales posibles</strong>: algunos te otorgarán la supervivencia heroica, otros te desvelarán secretos arcanos, y otros te conducirán a un destino aciago en las profundidades del mar.</li>
      </ul>
      <p style="text-align: center; font-style: italic; color: #8b1d1d; margin-top: 1.5rem;">
        ✦ Respira hondo, enciende tu farol y toma tu primera decisión en la sección <strong>1</strong>. ✦
      </p>
    </div>
  </div>

  <!-- SECCIONES NUMERADAS 1..25 -->
  ${sectionsHtml}
...
const htmlOutputPath = path.join(__dirname, '..', 'libro_la_ultima_guardia.html');
...
const pdfOutputPath = path.join(__dirname, '..', 'libro_la_ultima_guardia.pdf');
